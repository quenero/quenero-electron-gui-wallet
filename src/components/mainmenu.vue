...
<div>
    ...
    <q-modal minimized ref="aboutModal">
        <div class="about-modal">
            ...
            <p class="q-my-sm">Copyright (c)      2021, Quenero Project</p>
            <p class="q-my-sm">Copyright (c) 2018-2021, Oxen Project</p>
            <p class="q-my-sm">Copyright (c) 2018-2021, Ryo Currency Project</p>
